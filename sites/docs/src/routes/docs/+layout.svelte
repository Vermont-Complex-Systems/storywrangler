	...
	const nav = [
		{
			...
			items: [
				...
				{ label: 'Why register?', href: '/docs/why-register' }
			]
		},
		{
			title: 'Guides',
			items: [
				...
				{ label: 'Object model', href: '/docs/object-model' },
...
<div class="flex min-h-[calc(100vh-3.5rem)]">
	<!-- Left nav -->
	<aside class="border-border/40 sticky top-14 h-[calc(100vh-3.5rem)] w-60 shrink-0 overflow-y-auto border-r px-4 py-8 max-lg:hidden">
	...
	<div class="flex min-w-0 flex-1">
		<div class="min-w-0 flex-1 px-8 py-10">
			<div class="max-w-3xl">
			...
			<article
				class="prose dark:prose-invert prose-zinc max-w-3xl"
				{@attach attachToc}
			>
				{@render children()}
			</article>
